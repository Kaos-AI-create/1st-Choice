    ...
    <div className="pt-28 pb-16 md:pt-36 md:pb-24 bg-gradient-to-br from-blue-900 to-blue-700 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center md:text-left md:flex md:items-center md:justify-between">
          <div className="md:flex md:items-center md:max-w-xl"> {/* Modified this div to be a flex container for text and image */}
            <img
              src="/images/fci-lady.png"
              alt="Experienced insurance agent"
              className="max-w-md rounded-lg shadow-xl mr-8 mb-4 md:mb-0" // Added margin
            />
            <div>
          ...
          <div className="hidden md:block">
            <div className="w-60 h-60 lg:w-72 lg:h-72 relative">
              ...
              <div className="bg-white text-blue-900 p-6 rounded-lg shadow-xl relative z-10">
                <h3 className="text-2xl font-bold mb-4">Your Local Insurance Experts</h3> {/* Changed the title */}
                <p className="text-gray-700 mb-4">Serving San Antonio and surrounding areas since 2000.</p>
                <p className="text-sm font-semibold mb-2">With over 20 years of local expertise.</p> {/* Added the experience line */}
